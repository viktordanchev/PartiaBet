...
function PlayButton() {
    ...
    return (
        <div className={`relative px-6 py-3 rounded-xl bg-green-600 text-white font-medium shadow-md transform transition-all duration-300 ease-in-out hover:cursor-pointer ${showStakeOptions ? "scale-105" : "hover:scale-105"
            }`}
