...
function RegisterPage() {
    ...
    return (
        <section className="m-auto p-6">
            <article className="w-90 p-8 border border-gray-500 bg-gray-900 rounded-xl shadow-xl shadow-gray-900 space-y-6">
                <p className="text-3xl text-center text-gray-300">Welocme</p>
                <Formik
                    initialValues={{ username: '', email: '', vrfCode: '', password: '', confirmPassword: '' }}
